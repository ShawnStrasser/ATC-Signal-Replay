...
Summarize the release as 19 aggregate passes and six review cases. Identify 12036 as likely peer-to-peer test-environment failure. Emphasize that passed configurations still produced useful diagnostics: 13008 rail-preemption bug fix, 2B049 non-operational transition-algorithm difference and possible transition-state issue, and 13008 expected dynamic red-clear extension. Use the preempt and transition figures.
