...
The manuscript title page contains the single author information supplied by Shawn Strasser. The current PDF is 12 pages while all three temporary Figure 2 alternatives are included. Sensitivity reruns, detailed intervention verification, case-study metadata, final acknowledgments/agency approval, and the public release citation remain author-review items; do not submit until the blockers in `AUTHOR_REVIEW.md` are resolved.
